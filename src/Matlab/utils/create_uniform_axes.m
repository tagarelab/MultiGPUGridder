function coord_axes=create_uniform_axes(ntheta,nphi,disp_flag,fig_num)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for theta=90/ntheta:90/ntheta:90,
    %theta
    for phi=0:360/nphi:360-0.1,
        z=[sin(theta*alpha)*cos(phi*alpha) ...
            sin(theta*alpha)*sin(phi*alpha) ...
            cos(theta*alpha) ];
        tmp=get_axes_from_n_rot(z,30*alpha);
