...
public:
    ...
    // virtual float *BackProject();

    // // Set the volume
    // virtual void SetVolume(float *Volume, int *VolumeSize);
    ...
    // Set the CAS volume size
    void SetCASVolumeSize(int CASVolumeSize);

    // Set the CAS imagse size
    void SetCASImagesSize(int SetCASImgSize, int numCoordAxes);

    // Set the output projection images array
    void SetImages(float *imgs);

    // Set the output images size
    void SetImageSize(int *imgSize);

    // Set the coordinate axes pointer
    void SetCoordAxes(float *coordAxes);
    ...
    void SetCASImages(float *CASimgs);
