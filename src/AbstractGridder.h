...
protected:
    ...
    // Size of the CASvolume in bytes (size of CASvolume times the size of float)
    int CASVolumeBytes;
    ...
    // Size of the CAS projection images (on the CPU)
    int *CASimgSize;
...
public:
    ...
    float *GetCoordAxesPtr_CPU() { return this->coordAxes; }
