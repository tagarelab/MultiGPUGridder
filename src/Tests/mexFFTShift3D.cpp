...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    if (nrhs != 3)
    {
        mexErrMsgTxt("mexFFTShift3D: There should be 3 inputs, (1) Volume as a single array, (2) Volume size as int32, and (3) GPU device number as int32.");
    }
    ...
    FFTShift3DFilter<float> *FFTShiftFilter = new FFTShift3DFilter<float>();
    FFTShiftFilter->SetInput(d_InputVolume->GetPointer());
    FFTShiftFilter->SetVolumeSize(InputVolumeSize[0]);
